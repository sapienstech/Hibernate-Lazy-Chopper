...
public class EntityLazyInitializationChopper implements LazyInitializationChopper {
    ...
    public void init() throws IOException, ClassNotFoundException {
        ...
        String pattern = ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX + ClassUtils.convertClassNameToResourcePath(modelpackage) + RESOURCE_PATTERN;
        ...
        for (Resource resource : resources) {
            if (resource.isReadable()) {
                ...
                if (clazz.isAnnotationPresent(Chopped.class) || abstractEntityClass.isAssignableFrom(clazz) || clazz.getAnnotation(javax.persistence.Embeddable.class) != null) {
    ...
    private Map<Integer, Object> chopLazyAndReturnDescendants(Object node) throws IllegalAccessException, IllegalArgumentException, SecurityException, NoSuchFieldException {
    ...
    private void chopLazyField(Object node,
                               Map<Integer, Object> descendents,
                               Field field) throws IllegalAccessException, IllegalArgumentException, SecurityException, NoSuchFieldException {
    ...
    private void handleUnIntilizedProxy(Object node,
                                        Field field,
                                        Object fieldVal) throws IllegalAccessException {
        Object lazyReplacement = cloneProxy(fieldVal);
        field.set(node, lazyReplacement);
    }

    private void handleIntitialized(Map<Integer, Object> descendents,
                                    Object fieldVal,
                                    Object node,
                                    Field field) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        ...
        if (fieldVal instanceof PersistentCollection) {
            ...
            for (Object object : col)
                descendents.put(System.identityHashCode(object), object);
        } else if (fieldVal != null && (abstractEntityClass.isAssignableFrom(fieldVal.getClass()) || fieldVal.getClass().isAnnotationPresent(Chopped.class))) {
